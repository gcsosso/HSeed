...
Z_LAYER_REMOVE   = 23.5  # all OW (and corresponding HW, MW) below this z will be removed before crop
Z_LATTICE_CUTOFF = 28.5  # ==> this means, its value can be read directly from inputfile.POSCAR
